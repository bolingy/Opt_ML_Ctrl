...
model_bs = 3 # Batch size when learing from model
...
# line linear for observation and reward prediction
predicted_observation = tf.matmul(layer2M,wO,name="predicted_observation") + bO
predicted_reward = tf.matmul(layer2M,wR,name="predicted_reward") + bR
# sigmoid for done prediction
...
with tf.Session() as sess:
    ...
    while episode_number <= 5000:
        ...
        # assign action depends on policy net's probability ouput
        ...
        if done:
            ...
            # Calculate gradient for Policy Net, and Buffer
            ...
            # Get in this if every 3 episodes
            if switch_point + batch_size == episode_number:
                switch_point = episode_number
                # Train Policy with buffered gradients
                if trainThePolicy == True:
            ...
            # Reset Environment (real(simulation) or model)
